...
const SideNav = () => {
  ...
  return (
    <div className="border shadow-md h-screen p-5">
      ...
      {/* Display user info */}
      {user && (
        <div className="fixed bottom-5 left-2 w-60 bg-white rounded-xl shadow-md p-2 flex items-center justify-between gap-3 z-10 block">
          <div className="border-2 border-[#1A3A6E] flex rounded-lg justify-between w-full">
            <Button
